...
parser = argparse.ArgumentParser(
    description="Output the plot of tMSSink log.",
    formatter_class=argparse.ArgumentDefaultsHelpFormatter)
parser.add_argument("logfile", help="tMSSink log file to use for analysis")
...
pl.title("MSSink writing times per integration")
