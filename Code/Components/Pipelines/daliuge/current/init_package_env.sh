...
then
    DYLD_LIBRARY_PATH=${ASKAP_ROOT}/Code/Components/Pipelines/daliuge/current/install/lib:${ASKAP_ROOT}/Code/Base/askap/current/install/lib:${ASKAP_ROOT}/3rdParty/casacore/casacore-2.0.3/install/lib:${ASKAP_ROOT}/3rdParty/wcslib/wcslib-4.18/install/lib:${ASKAP_ROOT}/3rdParty/cfitsio/cfitsio-3.35/install/lib:${ASKAP_ROOT}/3rdParty/fftw/fftw-3.3.3/install/lib:${ASKAP_ROOT}/3rdParty/LOFAR/Common/Common-3.3/install/lib:${ASKAP_ROOT}/3rdParty/boost/boost-1.56.0/install/lib:${ASKAP_ROOT}/3rdParty/log4cxx/log4cxx-0.10.0/install/lib:${ASKAP_ROOT}/3rdParty/apr-util/apr-util-1.3.9/install/lib:${ASKAP_ROOT}/3rdParty/expat/expat-2.0.1/install/lib:${ASKAP_ROOT}/3rdParty/apr/apr-1.3.9/install/lib:${DYLD_LIBRARY_PATH}
else
    DYLD_LIBRARY_PATH=${ASKAP_ROOT}/Code/Components/Pipelines/daliuge/current/install/lib:${ASKAP_ROOT}/Code/Base/askap/current/install/lib:${ASKAP_ROOT}/3rdParty/casacore/casacore-2.0.3/install/lib:${ASKAP_ROOT}/3rdParty/wcslib/wcslib-4.18/install/lib:${ASKAP_ROOT}/3rdParty/cfitsio/cfitsio-3.35/install/lib:${ASKAP_ROOT}/3rdParty/fftw/fftw-3.3.3/install/lib:${ASKAP_ROOT}/3rdParty/LOFAR/Common/Common-3.3/install/lib:${ASKAP_ROOT}/3rdParty/boost/boost-1.56.0/install/lib:${ASKAP_ROOT}/3rdParty/log4cxx/log4cxx-0.10.0/install/lib:${ASKAP_ROOT}/3rdParty/apr-util/apr-util-1.3.9/install/lib:${ASKAP_ROOT}/3rdParty/expat/expat-2.0.1/install/lib:${ASKAP_ROOT}/3rdParty/apr/apr-1.3.9/install/lib
fi
