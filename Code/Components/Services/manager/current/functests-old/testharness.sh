#!/bin/bash
# This is the common test harness used to initialise the CP Manager functional test environment.
...
# From this point, all paths are relative to the test directory
echo Changing to test directory $1
cd $1
