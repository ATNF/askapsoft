...
namespace odb
{
  ...
  inline
  access::object_traits< ::askap::cp::sms::datamodel::Polarisation >::id_type
  access::object_traits< ::askap::cp::sms::datamodel::Polarisation >::
  id (const object_type& o)
  {
    return o.polarisation_component_id;
  }

  inline
  void access::object_traits< ::askap::cp::sms::datamodel::Polarisation >::
  ...
  inline
  void access::object_traits_impl< ::askap::cp::sms::datamodel::Polarisation, id_common >::
  ...
  inline
  access::object_traits_impl< ::askap::cp::sms::datamodel::Polarisation, id_common >::pointer_type
  ...
  inline
  bool access::object_traits_impl< ::askap::cp::sms::datamodel::Polarisation, id_common >::
  ...
  inline
  result< access::object_traits_impl< ::askap::cp::sms::datamodel::Polarisation, id_common >::object_type >
  access::object_traits_impl< ::askap::cp::sms::datamodel::Polarisation, id_common >::
  ...
  inline
  unsigned long long access::object_traits_impl< ::askap::cp::sms::datamodel::Polarisation, id_common >::
