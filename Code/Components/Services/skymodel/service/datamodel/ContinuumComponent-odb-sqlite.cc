...
namespace odb
{
        ...
        bool* t)
  {
    ...
    if (t[2UL])
    {
      i.observation_date_value.capacity (i.observation_date_size);
      grew = true;
    }
        ...
        sqlite::statement_kind sk)
  {
    ...
    b[n].buffer = i.observation_date_value.data ();
    b[n].size = &i.observation_date_size;
    b[n].capacity = i.observation_date_value.capacity ();
    ...
    b[n].size = &i.island_id_size;
    b[n].capacity = i.island_id_value.capacity ();
        ...
        sqlite::statement_kind sk)
  {
    ...
    //
    {
      ...
      bool is_null (true);
      std::size_t cap (i.observation_date_value.capacity ());
      sqlite::value_traits<
          ::boost::posix_time::ptime,
          sqlite::id_text >::set_image (
        i.observation_date_value,
        i.observation_date_size,
        is_null,
        v);
      i.observation_date_null = is_null;
      grew = grew || (cap != i.observation_date_value.capacity ());
    }
    ...
    else
    {
      switch (pass)
      {
        case 1:
        {
          ...
          db.execute ("CREATE INDEX \"ContinuumComponent_observation_date_i\"\n"
                      "  ON \"ContinuumComponent\" (\"observation_date\")");
          db.execute ("CREATE INDEX \"ContinuumComponent_healpix_index_i\"\n"
                      "  ON \"ContinuumComponent\" (\"healpix_index\")");
          db.execute ("CREATE INDEX \"ContinuumComponent_sb_id_i\"\n"
