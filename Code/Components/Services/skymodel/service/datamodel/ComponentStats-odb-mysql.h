...
#ifndef COMPONENT_STATS_ODB_MYSQL_H
#define COMPONENT_STATS_ODB_MYSQL_H
...
namespace odb
{
  ...
  //
  template <>
  class access::view_traits_impl< ::askap::cp::sms::datamodel::ComponentStats, id_mysql >:
  ...
  // ComponentStats
  //
  struct access::view_traits_impl< ::askap::cp::sms::datamodel::ComponentStats, id_mysql >::query_columns:
    odb::pointer_query_columns<
      ::askap::cp::sms::datamodel::ContinuumComponent,
      id_mysql,
      odb::access::object_traits_impl< ::askap::cp::sms::datamodel::ContinuumComponent, id_mysql > >
  {
  };
}

#include "ComponentStats-odb-mysql.i"

#include <odb/post.hxx>

#endif // COMPONENT_STATS_ODB_MYSQL_H
