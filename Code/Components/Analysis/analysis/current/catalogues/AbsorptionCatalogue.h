...
///
#ifndef ASKAP_ANALYSIS_ABSORPTION_CAT_H_
#define ASKAP_ANALYSIS_ABSORPTION_CAT_H_
...
/// catalogue of Absorption objects, as per the CASDA specifications.
...
class AbsorptionCatalogue : public CasdaCatalogue {
    public:
    ...
    protected:
        ...
        std::vector<CasdaAbsorptionObject> itsObjects;
