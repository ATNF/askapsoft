...
class SelavyObject:
    ...
    def __init__(self,line):
        ...
        if(line[0]!='#'):
            ...
            self.majDECONVerr = float(cols[23])
            self.minDECONVerr = float(cols[24])
            self.paDECONVerr = float(cols[25])
            self.chisqFIT = float(cols[26])
            self.rmsFIT = float(cols[27])
            self.alpha = float(cols[28])
            self.beta = float(cols[29])
            self.alphaErr = float(cols[30])
            self.betaErr = float(cols[31])
            self.RMSimage = float(cols[32])
            self.flag1 = int(cols[33])
            self.flag2 = int(cols[34])
            self.flag3 = int(cols[35])
            self.flag4 = int(cols[36])
