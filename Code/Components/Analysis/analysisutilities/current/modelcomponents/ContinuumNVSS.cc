...
void ContinuumNVSS::define(const std::string &line)
{
    ...
    itsRA_err         = atof(line.substr(90, 5).c_str());
    itsDecstring      = line.substr(96, 11);
    itsDec_err        = atof(line.substr(108, 4).c_str());
    ...
    itsMajorAxis_err  = atof(line.substr(138, 4).c_str());
    itsMinorAxisLimit = line[143];
    itsMinorAxis      = atof(line.substr(145, 5).c_str());
    itsMinorAxis_err  = atof(line.substr(151, 4).c_str());
    itsPA_input       = atof(line.substr(156, 5).c_str());
    itsPA_err         = atof(line.substr(162, 4).c_str());
