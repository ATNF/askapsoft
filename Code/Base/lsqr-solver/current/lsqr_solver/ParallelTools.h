...
/*
 * Defines model splitting for parallelization: calculates local number of elements (at current CPU).
 */
size_t calculate_nelements_at_cpu(size_t nelements_total, int myrank, int nbproc);
