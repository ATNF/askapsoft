...
struct MemTableSpWindowHolder : virtual public ITableSpWindowHolder {
  ...
  explicit MemTableSpWindowHolder(const casacore::Table &ms);
  ...
  virtual casacore::MFrequency::Ref
                    getReferenceFrame(casacore::uInt spWindowID) const;
  ...
  virtual const casacore::Unit& getFrequencyUnit() const throw();
  ...
  virtual const casacore::Vector<casacore::Double>&
                     getFrequencies(casacore::uInt spWindowID) const;
