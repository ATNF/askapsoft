...
public:
    ...
    virtual casacore::Double epoch(const casacore::MEpoch &in) const = 0;
    ...
    virtual casacore::MEpoch epochMeasure(casacore::Double in) const = 0;

    /// reverse conversion: form a measure from MVEpoch
    /// @param[in] in epoch given as MVEpoch in the target frame
    /// @return epoch converted to Measure
    virtual casacore::MEpoch epochMeasure(const casacore::MVEpoch &in) const = 0;
    ...
    virtual void direction(const casacore::MDirection &in,
                           casacore::MVDirection &out) const = 0;
    ...
    /// defined.
    ///
    virtual casacore::Double frequency(const casacore::MRadialVelocity &in) const = 0;
    ...
    /// defined.
    ///
    virtual casacore::Double velocity(const casacore::MFrequency &in) const = 0;
