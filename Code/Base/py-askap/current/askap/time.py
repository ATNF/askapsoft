...
DUTC0 = 36.0  # leap seconds - correct as of 30 June 2012
...
def utcdjd2bat(utcDJD, dutc=None):
    dutc = dutc or getDUTCDt()
...
def utcDt2batStr(utcDt, dutc=None):
    """
